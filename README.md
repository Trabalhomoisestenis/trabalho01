...
desenvolver esse projeto. O sistema  “shoesqdele” tem como objetivo gerenciar todas as
...
> O sistema proposto para o " shoesqdele" conterá as informações aqui detalhadas. Dos usuarios serão armazenados seu: nome,idade,sexo,altura,peso,e-mail e modelo do tenis que usa. Apos isso serão armazenados a partir de sensores a distancia que ele percorre,e as calorias gastas e tempo de exercício feito.Dos tenis serao armazenados seu preço,nome,quantidade,cor e tamanho disponivel.Dos exercicios serao guardados seu nome e a quantidade media de calorias gastas por hora e dos funcionarios serao armazenados seu nome,rg,cpf,salario,a data da contratação e seu supervisor 
